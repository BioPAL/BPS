...
- See the [Contributions](../about/licensing/contributions.md) and [REUSE compliance](../about/licensing/reuse-compliance.md) pages for complete requirements
...
- [Architecture](architecture.md) - Monorepo layout and `bps-*` modules
...
**Previous:** [Architecture](architecture.md) | **Next:** [Documentation standards](documentation-standards.md)
