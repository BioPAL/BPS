...
"""
Biomass L2b AGB processor main
------------------------------
"""
...
from bps.l2b_agb_processor.cli.run import cli
...
def main() -> int:
    ...
    try:
        ...
        if exit_exc.code == 0:
            bps_logger.info("%s correctly terminated", BPS_L2B_AGB_PROCESSOR_NAME)
            return SUCCESS_CODE
    ...
    bps_logger.error("%s abnormal termination", BPS_L2B_AGB_PROCESSOR_NAME)
    return FAILURE_CODE
