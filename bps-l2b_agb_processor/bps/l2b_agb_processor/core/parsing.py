...
from bps.l2b_agb_processor.core.translate_aux_pp2_2b_agb import (
    translate_model_to_aux_processing_parameters_l2b_agb,
)
from bps.l2b_agb_processor.core.translate_job_order import (
    translate_model_to_l2b_agb_job_order,
)
...
class InvalidAuxPP2_2B_AGB(RuntimeError):
    """Raised when the aux pp2 2b AGB content is not the correct format"""


def parse_l2b_job_order(job_order_content: str) -> L2bAGBJobOrder:
    ...
    return translate_model_to_l2b_agb_job_order(job_order_model)


def parse_aux_pp2_2b_agb(aux_pp2_2b_agb_content: str) -> AuxProcessingParametersL2BAGB:
    """Aux PP2 AGB XML parsing

    Parameters
    ----------
    aux_pp2_2b_agb_content : str
        content of the aux pp2 2b agb XML file

    Returns
    -------
    AuxProcessingParametersL2BAGB
        Object containing the L2bAGBProcessing Parameters
    ...
    try:
        model = parse(
            aux_pp2_2b_agb_content,
            aux_pp2_2b_agb_models.AuxiliaryL2BAbprocessingParameters,
        )
    except ParsingError as exc:
        raise InvalidAuxPP2_2B_AGB from exc

    return translate_model_to_aux_processing_parameters_l2b_agb(model)
