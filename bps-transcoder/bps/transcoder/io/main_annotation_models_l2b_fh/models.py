...
class MainAnnotationType:
    ...
    product: ProductL2BL3Type = field(
        metadata={
            "type": "Element",
            "namespace": "",
        },
    ...
    input_information: InputInformationL2BL3ListType = field(
        metadata={
    ...
    processing_parameters: ProcessingParametersL2BType = field(
        metadata={
...
class MainAnnotation(MainAnnotationType):
    """
    BIOMASS L2b FH product main annotation element.
    """
